...
!AirIntrusions Modification - 04-08-2025
  real(kind=dp) :: xold,yold !MM_04-08-2025
  real :: zold,xmean,ymean !,xold,yold
  !DEBUG PROCESS - 22-09-2025
!  real          ::  ixave_1, jyave_1
!  real :: xlon,ylat,xtmp,ytmp, x_lon1,y_lat1,x_lon2,y_lat2
!End AirIntrusions Modification
  
!  write(*,*) "xold", xold, "yold", yold
...
!       call xyindex_to_ll_wrf_out(0,ixave_1,jyave_1,x_lon2,y_lat2)
        ...
        x_lon1 = outlon0 + ixave*dxoutl
        y_lat1 = outlat0 + jyave*dyoutl
