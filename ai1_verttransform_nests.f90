...
!AirIntrusions Modification - 06-08-2025
          capen(ix,jy,1,n,l)=capehn(ix,jy,1,n,l)
          capen(ix,jy,nz,n,l)=capehn(ix,jy,nuvz,n,l)
...
!AirIntrusions Modification - 31-07-2025
                capen(ix,jy,iz,n,l)=capen(ix,jy,iz,n,l)
!End AirIntrusions Modification
...
!AirIntrusions Modification - 31-07-2025
               capen(ix,jy,iz,n,l)=(capehn(ix,jy,kz-1,n,l)*dz2 &
                    +capehn(ix,jy,kz,n,l)*dz1)/dz
!End AirIntrusions Modification               
