...
!AirIntrusions Modification - 31-07-2025
          cape(ix,jy,1,n)=capeh(ix,jy,1,n)    
          cape(ix,jy,nz,n)=capeh(ix,jy,nuvz,n)
...
!AirIntrusions Modification - 31-07-2025
                cape(ix,jy,iz,n)=cape(ix,jy,iz,n)
!End AirIntrusions Modification
...
!AirIntrusions Modification - 31-07-2025
               cape(ix,jy,iz,n)=(capeh(ix,jy,kz-1,n)*dz2 & 
                    +capeh(ix,jy,kz,n)*dz1)/dz
!End AirIntrusions Modification
