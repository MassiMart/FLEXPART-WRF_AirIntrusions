...
!MASSIMO MARTINA NEW VARIABLES Cold Point Computation - 13/12/2024
...
51    continue
     ...
     !Computation of the Cold Point Tropopause - AirIntrusions Package - MM_19-06-2025
      ...
      do kz=kzmin,nuvz-1
           ...
           if(tthn(ix,jy,kz-1,n,l)>tthn(ix,jy,kz,n,l) .and. tthn(ix,jy,kz,n,l)<tthn(ix,jy,kz+1,n,l)) then
              ...
              local_mins(jj) = tthn(ix,jy,kz,n,l)
      ...
      cold_tropopausen(ix,jy,1,n,l)=zlev(local_index)
      if(cold_tropopausen(ix,jy,1,n,l) == 0) then
         write(*,*) "cold tropopause: ", cold_tropopausen(ix,jy,1,n,l)
         ...
         write(*,*) "nuvz :", nuvz
         write(*,*) "cold tropo height", cold_tropopausen(ix,jy,1,n,l)
         write(*,*) "Lapse rate tropopause", tropopausen(ix,jy,1,n,l)
